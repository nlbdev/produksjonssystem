...
class Filesystem():
    ...
    def insert_css(path, library, format):
        ...
        latest_url = "https://github.com/nlbdev/nlb-scss/releases/download/2023-03-20/ncc.min.css"
        if library == "Statped":
            latest_url = "https://raw.githubusercontent.com/StatpedEPUB/nlb-scss/master/dist/css/statped.min.css"
        elif format == "epub":
            latest_url = "https://github.com/nlbdev/nlb-scss/releases/download/2023-03-20/epub.css"
        elif format == "daisy202":
            latest_url = "https://github.com/nlbdev/nlb-scss/releases/download/2023-03-20/html.min.css"
