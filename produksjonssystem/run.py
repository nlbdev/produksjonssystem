...
class Produksjonssystem():
    ...
    def __init__(self, environment=None, verbose=False):
        ...
        self.pipelines = [
            ...
            # lydbok-distribusjon
            # Deaktivert: lydbok-til-validering skriptet er skrudd av
    ...
    production_lines = [
        ...
        },
        {
            "id": "narration",
            "name": "Innlesing",
            "steps": ["insert-metadata-daisy202", "nlbpub-to-narration-epub", "dummy_innlesingmedhindenburg", "create-abstracts"],  # "daisy202-to-distribution-narrated" deaktivert
        },
        {
            "id": "narration-external",
            "name": "Ekstern innlesing",
            "steps": ["insert-metadata-daisy202", "nlbpub-to-narration-epub", "dummy_innlesingmedhindenburg", "create-abstracts"],  # "daisy202-to-distribution-external" deaktivert
        },
        {
            "id": "tts",
            "name": "Talesyntese",
            "steps": ["insert-metadata-daisy202", "nlbpub-to-tts-dtbook", "dummy_talesynteseipipeline1", "create-abstracts"],  # "daisy202-to-distribution-tts" deaktivert
            "filters": {
                "libraries": ["NLB", "Tibi"],
            },
        },
