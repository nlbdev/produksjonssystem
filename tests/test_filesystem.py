...
class FilesystemTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.target = os.path.normpath(os.path.join(os.path.dirname(os.path.realpath(__file__)), '..', 'target/fs'))
    ...
    def test_copy_locked_files(self):
        ...
        self.filesystem.copy(book1, target_book1)
        ...
        self.filesystem.copy(book2, target_book2)
        ...
        self.filesystem.copy(book3, target_book3)
