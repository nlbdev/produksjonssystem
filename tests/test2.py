...
try:(rmtree('/tmp/book-archive/distribusjonsformater/PEF/fullskrift/561195'))
except: pass
...
if  os.path.exists('/tmp/book-archive/distribusjonsformater/PEF/fullskrift/561195'):print("PEF fullskrift  is verified")
else:
