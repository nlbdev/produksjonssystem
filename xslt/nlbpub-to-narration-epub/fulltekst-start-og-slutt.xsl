...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template name="generer-tittel">
        <section epub:type="frontmatter titlepage" id="level1_nlb_tittel">
            ...
            <p>
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <!--<xsl:text>Det er [innleser] som leser.</xsl:text>-->
                        <xsl:text>Det er </xsl:text>
                        <xsl:value-of
                            select="fnk:hent-metadata-fra-nlbpub('dc:contributor.narrator', false())"/>
    ...
    <xsl:template name="generer-sluttinformasjon">
        ...
        <p>
            <!--
                psps-20171017: Hva gjør vi med denne?
                <xsl:text>Her slutter lydboka. </xsl:text>-->
    ...
    <xsl:template name="lydbokavtalen">
        <section epub:type="frontmatter" id="level1_nlb_lydbokavtalen">
            <h1>
                <xsl:choose>
                    <xsl:when test="$SPRÅK.en">
    ...
    <xsl:template name="info-om-boka">
        <section epub:type="frontmatter" id="level1_nlb_om_boka">
            <h1>
                <xsl:choose>
                    <xsl:when test="$SPRÅK.en">
            ...
            <xsl:choose>
                <xsl:when test="$SPRÅK.en">
                    ...
                    <p>
                        ...
                        <xsl:value-of select="fnk:hent-metadata-fra-nlbpub('schema:isbn', true())"/>
                        <xsl:text>.</xsl:text>
                    </p>
                    <p>
    ...
    <xsl:template name="info-om-den-tilrettelagte-utgaven">
        <section epub:type="frontmatter" id="level1_nlb_om_lydboka">
            <h1>
                <xsl:choose>
                ...
                <xsl:choose>
                    <xsl:when test="$SPRÅK.en">
                        ...
                        <xsl:choose>
                            ...
                            <xsl:otherwise>
                                <xsl:value-of select="fnk:tall-til-tallord($STRUKTUR.dybde,false(),false())"/>
