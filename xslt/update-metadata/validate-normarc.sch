...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
    ...
    <pattern>
        ...
        <rule context="marcxchange:record[$identifier and $is-translated]">
            <assert test="exists(marcxchange:datafield[@tag='041']/marcxchange:subfield[@code='h']) and not(starts-with($identifier,'5'))">For oversatte utgaver må originalspråk være definert i *041$h (med mindre boknummeret starter med "5").</assert>
