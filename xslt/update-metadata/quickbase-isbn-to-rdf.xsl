...
section dl {
    margin-left: 2rem;
            ...
            <body vocab="http://schema.org/" typeof="Book" resource="#book{$metadata[self::html:dd[@property='nlbprod:isbn.identifier']]}">
        ...
        <xsl:if test="$rdf-xml-path">
            <xsl:result-document href="{$rdf-xml-path}" indent="yes">
                <rdf:RDF>
                    ...
                    <rdf:Description rdf:about="#book{$metadata[self::html:dd[@property='nlbprod:isbn.identifier']]}">
