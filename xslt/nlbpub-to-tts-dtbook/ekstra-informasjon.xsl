...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- Denne filen definerer en template 'lag-span-eller-p-med-ekstra-informasjon' som legger inn ekstra informasjon i et p- eller span-element.
        
        Denne template kalles opp i forbindelse med håndteringen av lister og tabeller.
    -->
